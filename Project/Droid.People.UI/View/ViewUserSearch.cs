    ...
    public class ViewUserSearch : UserControlCustom
    {
        ...
        private void LoadFilteredUsers()
        {
            ...
            foreach (Person user in _filteredUsers)
            {
                ...
                {
                    case Gender.MALE:
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.male;
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Tag = "MALE";
                        break;
                    case Gender.FEMAL:
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.female;
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Tag = "FEMAL";
                        break;
                    case Gender.OTHER:
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.rainbow;
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Tag = "OTHER";
                        break;
                    case Gender.UNKNOW:
                        row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnGender)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.question;
                ...
                row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnDetail)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.report_user;
                row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnDelete)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.cross;
                row.Cells[_dgvSearchPerson.Columns.IndexOf(ColumnEdit)].Value = Tools.Utilities.UI.Resources.ResourceIconSet16Default.user_edit;
            }
        }

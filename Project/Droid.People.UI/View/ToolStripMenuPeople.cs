...
namespace Droid.People.UI
{
    public class ToolStripMenuPeople : RibbonTab
    {
        ...
        {
            _load.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.arrow_refresh;
            _load.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.arrow_refresh;
            _load.FlashEnabled = false;
        }
        public void StartRefreshLib()
        {
            _load.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.zoom_refresh;
            _load.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.zoom_refresh;
            _load.FlashImage = Tools.Utilities.UI.Resources.ResourceIconSet32Default.arrow_refresh;
        ...
        private void BuildPanelUser()
        {
            ...
            _rbWelcome.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.home_page;
            _rbWelcome.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.home_page;
            _rbWelcome.Click += _buttonClick;

            _open = new RibbonButton(GetText.Text("Open"));
            _open.Name = "Open";
            _open.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.folder_user;
            _open.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.folder_user;
            ...
            _load.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.arrow_refresh;
            _load.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.arrow_refresh;
            _load.FlashImage = Tools.Utilities.UI.Resources.ResourceIconSet32Default.arrow_refresh_small;
            _load.FlashEnabled = false;
            _load.Click += _buttonClick;

            _search = new RibbonButton(GetText.Text("Search"));
            _search.Name = "Search";
            _search.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.filter;
            _search.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.filter;
            _search.Click += _buttonClick;
            
            _create = new RibbonButton(GetText.Text("Create"));
            _create.Name = "Create";
            _create.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.user_edit;
            _create.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.user_edit;
            _create.Click += _buttonClick;

            _webActivity = new RibbonButton(GetText.Text("WebActivity"));
            _webActivity.Name = "Web activity";
            _webActivity.Image = Tools.Utilities.UI.Resources.ResourceIconSet32Default.spider_web;
            _webActivity.SmallImage = Tools.Utilities.UI.Resources.ResourceIconSet16Default.spider_web;
